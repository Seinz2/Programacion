...
public class Ejercicio2 {
	...
	public static void main(String[] args) {
		...
		while(validarFecha(dia,mes,anio)==false) {
			//pedir datos
			System.out.println("ERROR fecha incorrecta, vuelve a introducir una fecha: ");
			System.out.println("dia ");
			dia = teclado.nextInt();
			System.out.println("mes ");
			mes = teclado.nextInt();
	...
	/**
	 * te dice si la fecha es correcta
	 * @param dia : int
	 * @param mes : int
	 * @param anio : int
	 * @return : boolean
	...
	/**
	 * te calcula los dias que tiene cada mes
	 * @param mes : int
	 * @param anio : int
	 * @return : int
	 */
	...
	/**
	 * te calcula el numero total de dias
	 * @param dia : int
	 * @param mes : int
	 * @param anio : int
	 * @return : int
